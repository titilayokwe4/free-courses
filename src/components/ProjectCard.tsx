  ...
  return (
    ...
    >
      <div className="relative w-full h-56 rounded-2xl overflow-hidden mb-3">
        ...
        <button 
          onClick={handleLike}
          className={`absolute top-3 right-3 p-2 rounded-full backdrop-blur-sm transition-all duration-300 transform translate-y-[-10px] opacity-0 group-hover:translate-y-0 group-hover:opacity-100 cursor-pointer ${
            isLiked 
        ...
        {/* Hover Title */}
        <div className="absolute bottom-4 left-4 right-4 transform translate-y-[10px] opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
